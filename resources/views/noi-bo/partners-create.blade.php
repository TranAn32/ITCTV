...
@section('title', 'Thêm đối tác mới - Quản trị ITC')
...
<div class="dashboard">
    <div class="partners-container">
        ...
        <div class="partner-card">
            <h2>Thêm đối tác - khách hàng mới</h2>
            <p class="subtitle font-sans">Nhập thông tin chi tiết để thêm logo đối tác liên kết mới.</p>

            <form method="POST" action="/admin/partners" enctype="multipart/form-data" id="partnerForm">
                @csrf

                <div class="form-group">
                    <label for="name">Tên đối tác / khách hàng</label>
                    <input type="text" name="name" id="name" class="form-control" placeholder="Ví dụ: Bộ Khoa học và Công nghệ..." required value="{{ old('name') }}">
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_visible" id="is_visible" class="form-control">
                            ...
                            <option value="0" {{ old('is_visible') == '0' ? 'selected' : '' }}>Ẩn logo đối tác</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="upload-zone" id="uploadZone">
                        ...
                        <p>Nhấn hoặc kéo thả logo vào đây</p>
                        <p class="hint">Hỗ trợ: JPG, PNG, WebP — Tối đa 5MB</p>
                        <input type="file" name="partner_logo" id="partnerInput" accept="image/jpeg,image/png,image/webp" required>
                    </div>
                ...
                <div class="btn-group">
                    ...
                    <button type="submit" class="btn-submit" id="submitBtn">Thêm đối tác</button>
                </div>
            </form>
        </div>
    </div>
