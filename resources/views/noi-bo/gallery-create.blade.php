...
@section('title', 'Thêm hình ảnh mới - Quản trị ITC')
...
<div class="dashboard">
    <div class="gallery-container">
        ...
        <div class="gallery-card">
            ...
            <p class="subtitle font-sans">Tải lên hình ảnh hoạt động công ty kèm trích dẫn mô tả.</p>

            <form method="POST" action="/admin/gallery" enctype="multipart/form-data" id="galleryForm">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="upload-zone" id="uploadZone">
                        ...
                        <p>Nhấn hoặc kéo thả hình ảnh vào đây</p>
                        <p class="hint">Hỗ trợ: JPG, PNG, WebP — Tối đa 5MB</p>
                        <input type="file" name="gallery_image" id="galleryInput" accept="image/jpeg,image/png,image/webp" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="caption" id="caption" class="form-control" placeholder="Ví dụ: Buổi lễ ký kết hợp đồng với Bộ Khoa học & Công nghệ...">{{ old('caption') }}</textarea>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_visible" id="is_visible" class="form-control">
                            ...
                            <option value="0" {{ old('is_visible') == '0' ? 'selected' : '' }}>Ẩn hình ảnh</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="btn-group">
                    ...
                    <button type="submit" class="btn-submit" id="submitBtn">Thêm hình ảnh</button>
                </div>
            </form>
        </div>
    </div>
